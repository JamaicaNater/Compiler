...
#line 69 "src/parser.y"
                {
                    ...
                    add_child(progNode, (yyvsp[0].node));
                    ast = progNode;
                }
...
#line 77 "src/parser.y"
                { 
                    ...
                    add_child(declListNode, (yyvsp[0].node));
...
#line 83 "src/parser.y"
                {
                    tree* declListNode = make_tree(DECLLIST);
                    add_child(declListNode, (yyvsp[-1].node));
                    add_child(declListNode, (yyvsp[0].node));
                    (yyval.node) = declListNode;
                }
...
#line 91 "src/parser.y"
            {
                ...
                add_child(declNode, (yyvsp[0].node));
                (yyval.node) = declNode;
            }
...
#line 104 "src/parser.y"
                ...
                add_child(varDeclNode, (yyvsp[-5].node));
                ...
                add_child(varDeclNode->children[2], make_tree_with_val(INT, (yyvsp[-2].value)));
...
#line 138 "src/parser.y"
            {
                tree* varDeclNode = make_tree(VARDECL);
                add_child(varDeclNode, (yyvsp[-2].node));
...
#line 162 "src/parser.y"
                {
                    (yyval.node) = make_tree_with_val(TYPESPECIFIER, INT_TYPE);
                }
...
#line 166 "src/parser.y"
                {
                    (yyval.node) = make_tree_with_val(TYPESPECIFIER, CHAR_TYPE);
                }
...
#line 170 "src/parser.y"
                {
                    (yyval.node) = make_tree_with_val(TYPESPECIFIER, VOID_TYPE);
                }
...
#line 175 "src/parser.y"
            {
                ...
                add_child(funDeclNode, (yyvsp[-2].node));
            }
...
#line 182 "src/parser.y"
            {
                ...
                add_child(funDeclNode, (yyvsp[-1].node));
            }
...
#line 196 "src/parser.y"
            {
                scopeLevel--;
                add_child(funDeclNode, (yyvsp[0].node));
...
#line 228 "src/parser.y"
            ...
            add_child(formalDeclListNode, (yyvsp[0].node));
...
#line 234 "src/parser.y"
                {
            tree* formalDeclListNode = make_tree(FORMALDECLLIST);
            add_child(formalDeclListNode, (yyvsp[-2].node));
            add_child(formalDeclListNode, (yyvsp[0].node));
            (yyval.node) = formalDeclListNode;
		}
...
#line 242 "src/parser.y"
            {
                ...
                add_child(formalDeclNode, (yyvsp[-1].node));
...
#line 265 "src/parser.y"
            {
                tree* formalDeclNode = make_tree(FORMALDECL);
                add_child(formalDeclNode, (yyvsp[-3].node));
...
#line 283 "src/parser.y"
            {
                ...
                add_child(funBodyNode, (yyvsp[-2].node));
                add_child(funBodyNode, (yyvsp[-1].node));
...
#line 296 "src/parser.y"
                {
                    ...
                    add_child(localDeclListNode, (yyvsp[-1].node));
                    add_child(localDeclListNode, (yyvsp[0].node));
                    (yyval.node) = localDeclListNode;
                }
...
#line 309 "src/parser.y"
                    ...
                    add_child(statementListNode, (yyvsp[-1].node));
                    add_child(statementListNode, (yyvsp[0].node));
                    (yyval.node) = statementListNode;
		        }
...
#line 317 "src/parser.y"
                ...
                add_child(statementNode, (yyvsp[0].node));
...
#line 348 "src/parser.y"
                    ...
                    add_child(CompoundStmtNode, (yyvsp[-1].node));
...
#line 355 "src/parser.y"
                ...
                add_child(assignStmtNode, (yyvsp[-3].node));
                add_child(assignStmtNode, (yyvsp[-1].node));
...
#line 396 "src/parser.y"
                ...
                add_child(condStmtNode, (yyvsp[-2].node));
                add_child(condStmtNode, (yyvsp[0].node));
...
#line 403 "src/parser.y"
                    {
                tree* condStmtNode = make_tree(CONDSTMT);
                add_child(condStmtNode, (yyvsp[-4].node));
                add_child(condStmtNode, (yyvsp[-2].node));
                add_child(condStmtNode, (yyvsp[0].node));
                (yyval.node) = condStmtNode;
            }
...
#line 412 "src/parser.y"
            {
                ...
                add_child(loopStmtNode, (yyvsp[-2].node));
                add_child(loopStmtNode, (yyvsp[0].node));
...
#line 420 "src/parser.y"
                    {
                (yyval.node) = make_tree_with_val(RETURNSTMT, KWD_RETURN);   
		    }
...
#line 424 "src/parser.y"
                ...
                add_child(returnStmtNode, (yyvsp[-1].node));
...
#line 443 "src/parser.y"
                ...
                add_child(varNode->children[1], (yyvsp[-1].node));
                (yyval.node) = varNode;
            }
...
#line 478 "src/parser.y"
                ...
                add_child(expressionNode, (yyvsp[0].node));
...
#line 484 "src/parser.y"
            {
                ...
                add_child(expressionNode, (yyvsp[-1].node));
                (yyval.node) = expressionNode;
            }
...
#line 493 "src/parser.y"
            {
                (yyval.node) = make_tree_with_val(RELOP, LTE);                
		    }
...
#line 497 "src/parser.y"
                    {
		        (yyval.node) = make_tree_with_val(RELOP, LT);     
            }
...
#line 501 "src/parser.y"
            {
                (yyval.node) = make_tree_with_val(RELOP, GT);     
            }
...
#line 505 "src/parser.y"
                    {
                (yyval.node) = make_tree_with_val(RELOP, GTE);     
            }
...
#line 509 "src/parser.y"
            {
                (yyval.node) = make_tree_with_val(RELOP, EQ);     
            }
...
#line 513 "src/parser.y"
            {   
                (yyval.node) = make_tree_with_val(RELOP, NEQ);     
            }
...
#line 518 "src/parser.y"
            {
                ...
                add_child(addExprNode, (yyvsp[0].node));
...
#line 524 "src/parser.y"
                ...
                add_child((yyvsp[-1].node), (yyvsp[-2].node));
                add_child((yyvsp[-1].node), (yyvsp[0].node));
                add_child(addExprNode, (yyvsp[-1].node));
                (yyval.node) = addExprNode;
            }
...
#line 533 "src/parser.y"
                    {
                (yyval.node) = make_tree_with_val(ADDOP, ADD);     
            }
...
#line 537 "src/parser.y"
                    {
                (yyval.node) = make_tree_with_val(ADDOP, SUB);     
            }
...
#line 542 "src/parser.y"
            {
                ...
                add_child(termNode, (yyvsp[0].node));
                (yyval.node) = termNode;
            }
...
#line 548 "src/parser.y"
                ...
                add_child((yyvsp[-1].node), (yyvsp[-2].node));
                add_child((yyvsp[-1].node), (yyvsp[0].node));
                add_child(termNode, (yyvsp[-1].node));
                (yyval.node) = termNode;
            }
...
#line 557 "src/parser.y"
            {
                (yyval.node) = make_tree_with_val(MULOP, MUL);     
            }
...
#line 561 "src/parser.y"
                    {
                (yyval.node) = make_tree_with_val(MULOP, DIV);     
            }
...
#line 566 "src/parser.y"
                ...
                add_child(factorNode, (yyvsp[-1].node));
...
#line 572 "src/parser.y"
                    {
                tree* factorNode = make_tree(FACTOR);
                add_child(factorNode, (yyvsp[0].node));
                (yyval.node) = factorNode;
            }
...
#line 584 "src/parser.y"
                    {
		        tree* factorNode = make_tree(FACTOR);
		        add_child(factorNode, make_tree_with_val(INT, (yyvsp[0].value)));
                (yyval.node) = factorNode;
            }
...
#line 590 "src/parser.y"
            {
		        tree* factorNode = make_tree(FACTOR);
		        add_child(factorNode, make_tree_with_val(CHAR, (yyvsp[0].value)));
                (yyval.node) = factorNode;
            }
...
#line 606 "src/parser.y"
                    ...
                    add_child(funcCallExprNode, (yyvsp[-1].node));
...
#line 674 "src/parser.y"
                ...
                add_child(argListNode, (yyvsp[0].node));
...
#line 680 "src/parser.y"
            {
                tree* argListNode = make_tree(ARGLIST);
                add_child(argListNode, (yyvsp[-2].node));
                add_child(argListNode, (yyvsp[0].node));
                (yyval.node) = argListNode;
            }
